...
function Banner({
  ...
  return /* @__PURE__ */ jsxs("div", { role: "region", style: {
    ...
    /* @__PURE__ */ jsxs("div", { "data-aqus-banner-body": true, style: {
      position: "relative",
      display: "flex",
      ...
      /* @__PURE__ */ jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 10, justifyContent: "center", flexWrap: "wrap" }, children: [
      ...
      action && /* @__PURE__ */ jsx("span", { style: { flex: "none" }, children: action })
    ] }),
