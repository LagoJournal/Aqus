...
function NavBar({
  ...
  return /* @__PURE__ */ jsxs("nav", { style: {
    ...
    action && /* @__PURE__ */ jsx("div", { style: { position: "relative", flex: "none" }, children: action })
  ] });
}
function Footer({
  columns = [],
    ...
    /* @__PURE__ */ jsxs("div", { style: { position: "relative", display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }, children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "baseline", gap: 10 }, children: [
          ...
          delta !== void 0 && /* @__PURE__ */ jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 4, fontSize: "var(--text-label)", fontWeight: "var(--weight-semibold)", color: up ? "var(--success)" : "var(--danger)" }, children: [
...
function MediaCard({
  ...
  return /* @__PURE__ */ jsxs(
    Tag2,
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsxs("div", { style: { position: "relative", height: mediaHeight, overflow: "hidden", background: "linear-gradient(145deg, var(--accent-mid), var(--accent))" }, children: [
          /* @__PURE__ */ jsx("div", { style: {
            position: "absolute",
            inset: 0,
        ...
        (title || subtitle || children) && /* @__PURE__ */ jsxs("div", { style: { padding: "var(--space-4) var(--space-5)" }, children: [
