...
function StatCard({
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: { position: "relative", display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }, children: [
      /* @__PURE__ */ jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
        /* @__PURE__ */ jsx("div", { style: { fontSize: "var(--text-label)", fontWeight: "var(--weight-medium)", color: "var(--text-muted)", marginBottom: "var(--space-2)", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, children: label }),
        /* @__PURE__ */ jsx("span", { style: { display: "block", fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "var(--text-display-lg)", lineHeight: 1.05, color: "var(--text)", overflowWrap: "anywhere" }, children: value }),
        delta !== void 0 && /* @__PURE__ */ jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 5, marginTop: "var(--space-2)", fontSize: "var(--text-label)", fontWeight: "var(--weight-semibold)", color: up ? "var(--success)" : "var(--danger)", whiteSpace: "nowrap" }, children: [
          /* @__PURE__ */ jsx(LiquidBubble, { size: 7, color: up ? "var(--success)" : "var(--danger)" }),
          delta
        ] })
      ] }),
